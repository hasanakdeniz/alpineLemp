...
CMD sh -c "chown -R www:www /var/lib/nginx && chown -R www:www /home/alpine/www && chmod -R 2775 /home/alpine/www && cd /home/alpine/www && /usr/sbin/sshd && php-fpm84 && nginx -g 'daemon off;'"
